...
//        try {
//            Activity currentActivity = StyleUtils.contextThemeWrapperToActivity(context);
//            InputMethodManager manager = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
//            if (currentActivity.getWindow().getAttributes().softInputMode != WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN) {
//                if (currentActivity.getCurrentFocus() != null) {
//                    manager.hideSoftInputFromWindow(currentActivity.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
//
//                }
//            }
//        } catch (Exception e) {
...
//     * @param pEtText the p et text
//     */
//    public static void showSoftInput(Context context, EditText pEtText) {
...
//            InputMethodManager manager = (InputMethodManager) context.getSystemService(Context.INPUT_METHOD_SERVICE);
//            Activity currentActivity = StyleUtils.contextThemeWrapperToActivity(context);
//            pEtText.requestFocus();
//            manager.showSoftInput(currentActivity.getCurrentFocus(), InputMethodManager.SHOW_IMPLICIT);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
